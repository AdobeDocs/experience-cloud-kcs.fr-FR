...
6. <b>Réindexez tous les index Oak asynchrones.</b>
   ...
   5. Redémarrez Adobe Experience Manager et surveillez vos fichiers journaux pour les messages de journal INFO provenant de `org.apache.jackrabbit.oak.plugins.index`. Si vous souhaitez afficher plus de détails sur l’indexation, accédez à l’interface utilisateur /system/console/slinglog et activez la journalisation du niveau de débogage pour `org.apache.jackrabbit.oak.plugins.index`.
