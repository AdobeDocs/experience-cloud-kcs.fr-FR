...
<br><br><br><br> <br><br>1. Installation du dernier CFP/SP<br><br><br><br> <br><br>
Vous trouverez les derniers correctifs sur [Adobe Package Share](https://www.adobeaemcloud.com/content/packageshare.html).
<br><br><br><br> <br><br>2. Exécution de la vérification de cohérence de l’entrepôt de données<br><br><br><br> <br><br>
Utilisation `oak-run` jar 1.6.6 et versions ultérieures, exécutez la commande suivante :
...
<br><br><br><br> <br><br>3. Création d’une liste de chemins d’accès aux fichiers manquants<br><br><br><br> <br><br>
...
a. <b>Dans [!DNL Linux] ou [!DNL Unix]:</b> Utilisez cette commande pour générer la liste des fichiers manquants dans un fichier. *missing_ds_files.txt*:
<br><br><br><br><br> <br><br><br><br>
...
\*\* Si votre instance Adobe Experience Manager ne démarre pas en raison des erreurs &quot;blobId&quot;, recherchez vos fichiers journaux sous `crx-quickstart/logs` pour toutes les occurrences de l’erreur &quot;Une erreur s’est produite lors de l’obtention de InputStream pour blobId&quot; à la place :
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br> <br><br>
b. <b>Dans [!DNL Windows]:</b>  Utilisez un éditeur de texte tel que [!DNL Textpad] ou [!DNL Notepad++] pour rechercher toutes les occurrences de &quot;Enregistrement introuvable&quot;.  Ensuite, après avoir trouvé toutes ces occurrences, extrayez les noms de fichier à l’aide d’une macro, écrivez un script ou en copiant et en construisant manuellement les noms de fichier dans un nouveau fichier texte.
...
<br><br><br><br><br> <br><br>
l’ID d’enregistrement est `add1dd8fc5093b27b1fae1b753cb48b24ef3231f` et le chemin d’accès au fichier est `ad*/d1/dd/add1dd8fc5093b27b1fae1b753cb48b24ef3231f*`
<br><br><br><br> <br><br>4. Récupération des fichiers manquants<br><br><br><br> <br><br>
...
<br><br><br><br><br> <br><br>
La commande exécute une synchronisation qui se copie sur tous les fichiers répertoriés dans `missing_ds_files.txt` qui existent dans le serveur.
<br><br><br><br> <br><br>5. Nettoyer les références de fichier non récupérables<br><br><br><br> <br><br>
...
Examinez chacun des chemins de noeud répertoriés qui font référence à des fichiers de banque de données manquants.  Examinez les ressources ou fichiers DAM manquants téléchargés sur les pages avec votre utilisateur.  Demandez-leur de télécharger à nouveau les fichiers manquants dont ils ont besoin.  Tout ce dont ils n’ont pas besoin peut être supprimé en toute sécurité via l’interface utilisateur d’Adobe Experience Manager.  S’il manque un élément sous `/var/audit` ou `/var/eventing` peut être supprimé en toute sécurité.  Pour tous les fichiers dont vous n’êtes pas sûr, accédez à [here](https://helpx.adobe.com/fr/marketing-cloud/contact-support.html) et contactez l’équipe d’assistance AEM pour obtenir de l’aide.
<br><br><br><br> <br><br>6. Réindexation de tous les index Oak asynchrones<br><br><br><br> <br><br>
Puisque les fichiers d’index sont stockés dans le référentiel Oak, il est également possible que certains fichiers soient manquants dans `/oak:index` indexation basée sur lucene.

Ces fichiers manquants ne seraient pas signalés dans la variable `/system/console/repositorycheck` vérification de cohérence, car elles sont masquées des traversées de référentiel.  Malheureusement, de tels fichiers ne correspondraient pas entre différentes instances AEM.
...
1. Télécharger `oak-run` 1.0.x correspondant à la version que vous avez installée dans votre environnement Oak : [https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/](https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/)

2. Téléchargez le `oak-run` sur le serveur Adobe Experience Manager.
...
<br><br><br><br><br> <br><br>
5. Redémarrez Adobe Experience Manager et surveillez vos fichiers journaux pour les messages de journal INFO provenant de `org.apache.jackrabbit.oak.plugins.index`.  Si vous souhaitez afficher plus de détails sur l’indexation, accédez à `/system/console/slinglog` L’interface utilisateur et l’activation de la journalisation du niveau de débogage pour `org.apache.jackrabbit.oak.plugins.index`.
