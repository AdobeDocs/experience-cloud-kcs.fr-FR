...
3. Optimisez les bibliothèques clientes.
   ...
   3. [Incorporer les bibliothèques client](https://helpx.adobe.com/fr/experience-manager/6-3/sites/developing/using/clientlibs.html) pour réduire les fichiers js et css.
