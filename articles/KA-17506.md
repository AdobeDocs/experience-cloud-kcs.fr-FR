...
- Utilisez la variable <b>Suivez le flux TCP</b> pour isoler le flux sur lequel vous travaillez.<br><br>    Fermez la fenêtre de texte rouge/bleu qui s’affiche, car elle n’est utile que pour les protocoles de texte qui ne sont pas pertinents pour SMPP.
