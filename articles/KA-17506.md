...
<br>Problème<br>Découvrez comment analyser le trafic SMPP à l’aide de Wireshark.<br><br>Environnement<br>La plupart des centres de services de messages courts (SMS-C) à haut débit sont compatibles avec le protocole SMPP version 3.4. Ce protocole permet d&#39;envoyer des SMS et de recevoir des informations sur la diffusion de ces SMS. Le protocole SMPP est documenté dans la spécification du protocole SMPP v3.4 disponible sur Internet au format PDF.<br><br>
...
Capture du trafic réseau sans Wireshark Si vous n’avez pas d’accès direct à la machine, il peut être nécessaire de capturer à l’aide d’outils de ligne de commande tels que tcpdump. Si vous connaissez déjà le port TCP de la connexion, appliquez le filtre approprié afin d’éviter de capturer tout le trafic. Voici un exemple de ligne de commande tcpdump pour capturer le port 12345 sur <b>outfile.pcap</b>:
...
<br>Initialisation de la connexion SMPP<br>
...
![smpp5](https://helpx.adobe.com/content/dam/help/en/campaign/kb/smpp-protocol-wireshark/jcr_content/main-pars/image_1891077095/smpp5.png "smpp5")<br>Encoder des MT<br>
Attention :
...
<br>En-tête de données utilisateur (UDH)<br>
...
<br>Déchiffrer le champ short_message du SR<br>
...
<br>Plusieurs SR pour le même MT<br>
