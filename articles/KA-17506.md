...
source-git-commit: 0070ebb54876821dfad25e32565cc3e0c74c7a28
workflow-type: tm+mt
...
- Pour isoler des paquets par numéro de téléphone ou par contenu textuel, utilisez la fonction de recherche avec les paramètres suivants :<br>\
...
Le flux est composé de PDU indépendants : chaque PDU est un message contenant une commande, un état, un numéro de séquence et d’autres informations basées sur la commande.
...
<b>Émetteur, récepteur et émetteur : </b>Le connecteur SMPP pour Campaign Classic fonctionne en mode Transmitter/receiver distinct : il existe deux connexions TCP, une pour transmettre MT et une autre pour recevoir MO et SR. Notez que la connexion TCP est toujours lancée par Campaign, même pour le mode récepteur.
...
| Encodage | data_coding | Taille du message (caractères) | Taille de partie pour un SMS en plusieurs parties | Caractères disponibles |
| --- | --- | --- | --- | --- |
