...
Cet article est fourni comme exemple général uniquement. Vous devez contacter votre gestionnaire du succès client Adobe Campaign afin d’obtenir le dimensionnement exact dont vous avez besoin pour votre déploiement avant de démarrer un projet Campaign. <b>Ne pas</b> acquérir ou déployer toute infrastructure ou tout matériel jusqu’à ce que cela soit fait.
