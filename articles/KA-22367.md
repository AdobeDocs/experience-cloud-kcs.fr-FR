...
Après la création de la configuration SAML 2.0 pour activer la connexion SSO sur leur auteur de production, le client a reçu un message d’erreur du côté AEM après que le fournisseur Azure a effectué la connexion et récupéré le jeton SAML, pour effectuer l’authentification du côté AEM.<br><br> <br><br>L’erreur reçue a été `[` 1`]` <br><br> <br><br><b>`[` 1`]`  \*ERROR\* `[` qtp1558388453-153215`]`  Le paramètre de réponse SAML com.adobe.granite.auth.saml.SamlAuthenticationHandler n’a pas été fourni ou n’est pas valide.</b>
...
L’erreur 403 s’affiche généralement si le filtre de référent Apache Sling n’est pas activé. La vérification de la configuration du filtre de référent Apache Sling de l’option &quot;Autoriser vide&quot; n’a pas été cochée et aucun hôte n’a été ajouté à &quot;Autoriser les hôtes&quot;.
...
Après avoir effectué ces étapes requises, cochez &quot;Allow Empty&quot; et l’ajout des hôtes représentant le fournisseur IdP à &quot;Allow Hosts&quot;, la connexion a réussi.



REMARQUE:

L’URL IDP doit être ajoutée à la configuration Apache Sling Referrer Filter sans inclure le protocole, par exemple aem-sso-saml au lieu de https://aem-sso-saml
