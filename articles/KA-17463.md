...
[&lt;- Précédent : Purge du Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17493.html?lang=fr)
...
![Menu déroulant de la boîte de dialogue pour AEM interface utilisateur de création sur l’écran de l’éditeur de site](assets/aem-page-properties-drop-down.png "aem-page-properties-menu déroulant")![page de boîte de dialogue propriétés de la page aem](assets/aem-page-properties.png "aem-page-properties")

#### Classic Content Finder :

![Propriétés de la page sidekick de l’interface utilisateur classique AEM siteadmin](assets/aem-page-properties-sidekick.png "aem-page-properties-sidekick")![Boîte de dialogue des propriétés de page de l’interface utilisateur classique](assets/aem-page-properties-classic.png "aem-page-properties-classic")
...
![capture d’écran de la console d’une entrée de redirection vers un microsite dans les règles de résolution des ressources](assets/vanity-resource-resolver-entry.png "vanity-resource-resolver-entry")
...
![capture d’écran du contenu rendu à partir de /libs/granite/dispatcher/content/vanityUrls.html](assets/vanity-url-component.png "vanity-url-component")
...
[Next -> Common Logging](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html?lang=fr)