...
keywords: "KCS, URL Vanity, AEM, experience manager, règles de réécriture"
...
Ce document vous aidera à comprendre comment AEM traite les URL de redirection vers un microsite et certaines techniques supplémentaires, telles que l’utilisation de règles de réécriture pour mapper le contenu plus près de la périphérie de la diffusion.
