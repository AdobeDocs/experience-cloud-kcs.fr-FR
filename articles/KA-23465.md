...
La file d’attente de réplication est régulièrement bloquée pour l’un de nos clients AEMaaCS. Cet article décrit la solution suggérée par l’équipe d’ingénierie qui peut être exécutée dans l’interface utilisateur à l’aide des autorisations d’administrateur.
...
L’une de nos files d’attente de réplication des clients AEMaaCS est régulièrement bloquée en raison de l’exception javax.jcr.NamespaceException : préfixe d’espace de noms inconnu : exception ns22_ .
...
Le déblocage de la file d’attente nécessite simplement la suppression de la demande de l’interface utilisateur de la file d’attente de publication dorée. Veuillez suggérer au client d’effectuer les étapes ci-dessous.
