...
Cependant, le pipelineExecutionFailureReasons indique un &quot;ASSETS_TESTS_AUTHOR_CONNECTION_ERROR&quot; avec le code d’erreur &quot;002_010_006&quot; et le message :
...
Cependant, l’utilisateur de cloudmanager existe et le chargement manuel des ressources sur l’auteur fonctionne comme prévu.

Le test de performance des ressources fonctionne pendant 30 minutes, puis échoue soudainement de manière répétée, tandis que le test doit s’arrêter après 30 minutes. `[` 1`]`
...
En vérifiant les journaux de la fonction Azure interne, la requête dont le résultat est 404 Not Found a été trouvée.

La GET à l’URL à partir du champ &quot;message&quot; a renvoyé 404 `[` 1`]` .

L’échec dans ce cas est dû au fait que, suivant la recommandation de l’Adobe, querybuilder a été bloqué au niveau du Dispatcher.

Toutefois, Cloud Manager doit autoriser Query Builder sur le Dispatcher pour l’utilisateur de Cloud Manager, car pendant le test de la ressource, il récupère le temps de traitement.
