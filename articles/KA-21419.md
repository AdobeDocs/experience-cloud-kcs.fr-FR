...
<b>Description</b> : échec de l’exécution du pipeline pendant l’étape de création en raison des erreurs dans le code ui.frontend.

Vous constatez des messages ERROR comme ceux ci-dessous dans le fichier build.log :
...
- localisez dans la racine du référentiel git le fichier pom.xml et recherchez la version du nœud
par exemple : nodeVersion10.13.0/nodeVersion

- recherchez ui.frontend/package.json et ajoutez l’objet devDependencies déjà présent :
par exemple :
...
2. la version du nœud peut être différente dans votre cas. Par exemple : 12.22.7
