...
# Désactivation de la variable [!DNL Dispatcher] Déploiement
...
Mettre un commentaire en commentaire ou supprimer [!DNL Dispatcher] du module principal `pom.xml` (voir ci-dessous). Ensuite, redéclenchez le pipeline qui ignore la variable [!DNL Dispatcher] modifie et déploie uniquement AEM base de code par rapport à l’éditeur et à l’auteur.
