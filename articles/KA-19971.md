...
Impossible de supprimer un composant dans la AEM de création v6.5.10 avec le message d’erreur d’exception suivant :
...
La cause principale est dans votre code personnalisé :

`/content/intelligentcontent/brands/mch/en/home/jcr:content/root/container/container_412820554.infinity.json`

On dirait que le problème est autour de la ligne 6 et de la position 25.
