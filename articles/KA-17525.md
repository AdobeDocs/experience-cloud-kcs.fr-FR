---
title: "Solutions pour l’accès à l’environnement de test de Chrome refusé par erreur en Flash"
...
# Solutions pour l’accès à l’environnement de test de Chrome refusé en Flash

## Description


Lorsque vous lisez le flux Accès Adobe dans Google Chrome, vous rencontrez une erreur DRM : 3321 : i15nFailed lorsque vous refusez la bannière de sécurité pour le Flash Player.

<b>Remarque : </b>Dans les versions plus récentes de Google Chrome, une erreur DRM plus spécifique : 3368 : UserSettingsNoAccess s’affiche si vous cliquez sur le bouton Refuser dans la bannière de sécurité.
...
- Ouvrez Google Chrome, cliquez sur le menu Options dans le coin supérieur droit de Chrome.
