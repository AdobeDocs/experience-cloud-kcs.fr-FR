---
title: "[!DNL Control Panel] Fonctionnalités"
...
# [!DNL Control Panel] Fonctionnalités

## Description

Adobe Campaign [!DNL Control Panel] permet aux administrateurs d’Adobe Campaign de surveiller les ressources clés et d’effectuer des tâches administratives, telles que la gestion des listes autorisées d’adresses IP, l’enregistrement SFTP par instance et la gestion des clés ou sous-domaines GPG et des certificats. Tous vos [!DNL Campaign] les ressources, les workflows et les données de l’instance sont stockés dans la base de données. La base de données atteignant sa capacité maximale peut entraîner des problèmes avec votre instance (impossibilité de se connecter, d&#39;envoyer des emails, etc.). Par conséquent, il est essentiel de surveiller régulièrement les bases de données de vos instances pour garantir des performances optimales.

Aujourd&#39;hui, [!DNL Control Panel] offre les fonctionnalités suivantes, avec de nouvelles fonctionnalités fréquemment ajoutées et des améliorations.
...
1. Gestion SFTP
   ...
   - [[!UICONTROL Gestion des clés]](https://experienceleague.adobe.com/docs/control-panel/using/sftp-management/key-management.html?lang=fr)
...
1. Sous-domaines et certificats
...
<b>Accès [!DNL Control Panel] - </b>Pour accéder au [!DNL Control Panel]. accéder à [Accueil Experience Cloud](https://experiencecloud.adobe.com) Accès rapide ou accueil Experience Cloud [!DNL Campaign] [!DNL Control Panel]

Si vous ne parvenez pas à accéder à la variable [!DNL Control Panel] cela serait dû à l’absence des droits d’administrateur de produit de votre profil. Contactez un administrateur existant de votre entreprise pour vous aider à obtenir les droits d’accès requis.
