...
Le document décrit les entrées de journal courantes que vous verrez, ce qu’elles signifient et comment les traiter.<br><br> <br><br>[Table des matières](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17490.html?lang=fr)
...
Depuis la version 4.2.x du module Dispatcher, ils ont commencé à décourager les utilisateurs d’utiliser le type de correspondance suivant dans leur fichier de filtres :
...
Cela nous fait savoir que notre fichier de conception .eot est bloqué et que nous allons vouloir le réparer.
...
Cela se produit lorsque l’adresse IP incorrecte est configurée dans la section renders de votre ferme de serveurs. Cette instance ou l’instance AEM a cessé de répondre ou d’écouter et le dispatcher ne peut pas l’atteindre.
...
Cette erreur se produit lorsque vous avez configuré votre Dispatcher pour utiliser le filtre automatique dynamique pour autoriser les URL de redirection vers un microsite, mais que vous n’avez pas terminé la configuration en installant le package sur le moteur de rendu AEM.

Pour corriger ce problème, installez le pack de fonctionnalités URL Vanityurl sur l’instance AEM et autorisez l’utilisateur anonyme à le préparer. Détails [here](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17463.html%3Flang%3Den)
