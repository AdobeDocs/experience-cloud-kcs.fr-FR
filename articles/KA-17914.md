...
Ces entrées ne s’affichent pas toujours même si des rejets se produisent si le niveau de journal est trop bas. Définissez-le sur Info ou déboguer pour vous assurer que vous pouvez voir si les filtres rejettent les requêtes.
...
Pour corriger ce problème, installez le pack de fonctionnalités URL Vanity sur l’instance AEM et autorisez l’utilisateur anonyme à le préparer. Détails [here](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17463.html?lang=fr)
