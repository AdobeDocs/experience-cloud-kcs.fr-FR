...
Impossible de récupérer les erreurs TrustStore affichées dans le journal.
...
Corruption dans la truststore.


## Résolution


1. Ouvrir <b>CRX/DE</b> en tant qu’utilisateur administrateur.

2. Supprimer le noeud `/etc/truststore/truststore.p12`.

3. Cliquez sur <b>[!UICONTROL Enregistrer tout]</b>.

4. Recréez TrustStore comme indiqué ci-dessous :
