...
article-created-date: "10/10/2022 6:38:04 PM"
article-published-by: Roxann McGlumphy
article-published-date: "10/10/2022 9:34:27 PM"
version-number: 2
article-number: KA-17483
dynamics-url: "https://adobe-ent.crm.dynamics.com/main.aspx?forceUCI=1&pagetype=entityrecord&etn=knowledgearticle&id=6f4149ab-ca48-ed11-bba1-000d3a3064b8"
source-git-commit: 69d810933a4a96ecb39e6bd40c33dc881c6993d8
workflow-type: tm+mt
...
`$ lsattr -Rl``/etc/httpd` `2``/dev/null` `|``grep` `Immutable`<br><br><br> <br><br>
...
Le serveur web Apache sait maintenant que le domaine est quelque chose qui devrait générer du trafic, mais nous devons toujours informer le module de Dispatcher qu’il a un nouveau nom de domaine à honorer.  Nous allons commencer par créer un nouveau fichier \*_vhost.any /etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any et dans ce fichier, nous allons placer le nom de domaine que nous voulons honorer :
