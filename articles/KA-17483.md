...
![Montre une piste de bowling avec une boule qui roule le long de la piste.  La balle a une flèche avec le mot &quot;vous&quot;.  Les pare-chocs sont levés et les mots &quot;fichiers immuables&quot; apparaissent au-dessus.](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/bowling-file-immutability.png "bowling-file-immutability")
Comme illustré dans l&#39;image ci-dessus, les fichiers immuables ne vous empêchent pas de jouer au jeu.Ils vous empêchent juste de nuire à vos performances et vous maintiennent sur la piste.Cette méthode nous permet d’accéder aux quelques fonctionnalités clés :
