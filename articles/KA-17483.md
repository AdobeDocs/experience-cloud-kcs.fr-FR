...
Ce document décrit les fichiers verrouillés et à ne pas modifier, ainsi que la manière de définir correctement les paramètres de configuration souhaités dans Adobe Experience Manager.
...
Nous avons copié les `aem_publish.vhost` parce qu&#39;il a déjà ce dont nous avons besoin pour que les choses fonctionnent et nous ne voulons pas réinventer un départ déjà fort.  Maintenant, nous éditons le nouveau fichier weretail.vhost et nous apportons les modifications nécessaires.
