...
Si le problème est dû au nettoyage de la mémoire de révision (cause #2), <b>assurez-vous que le compactage en ligne est désactivé. </b>pour éviter que d’autres noeuds ne soient corrompus.
...
Cela peut être utilisé pour rétablir manuellement un magasin de segments corrompu à sa dernière bonne révision.

*Attention :<b>* </b>Ce processus restaurera les données du système à un point antérieur dans le temps.
...
4. Répétez l’étape 3 pour tous les noeuds trouvés à l’étape 2.
   ...
   Ceci ci-dessus `rmNode` La commande doit renvoyer la valeur true pour le chemin corrompu, ce qui signifie qu’elle l’a supprimé.
...
6. Exécutez une compression hors ligne.
