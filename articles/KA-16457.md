...
4. Rétablissez le référentiel à cette révision en le modifiant.
   ...
   Supprimez toutes les lignes après la ligne contenant la dernière bonne révision. Si vous souhaitez connaître la date et l’heure auxquelles vous rétablissez le référentiel, exécutez cette commande dans le dossier segmentstore (remplacez afdb922d-ba53-4a1b-aa1b-1cb044b535cf par la dernière bonne révision de votre journal.log) :
