...
Je voudrais arrêter l’émission du cookie `s_sq` du cookie, mais je ne sais pas comment faire.
...
Décochez « [!UICONTROL Activer ClickMap] » si vous avez activé ClickMap dans le paramètre [!UICONTROL Suivi des liens] de l’extension Adobe Analytics dans la balise Adobe Experience Platform.
