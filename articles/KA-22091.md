---
title: "Échec du pipeline avec l’erreur \"La propriété end_aem_createsegmentstore est manquante\""
...
# Échec du pipeline avec l’erreur &quot;La propriété end_aem_createsegmentstore est manquante&quot;

## Description {#description}

Le pipeline CI/CD continue à échouer pendant l’étape &quot;Déploiement vers le développement&quot;. <br><br>Les journaux de déploiement n’affichaient aucune erreur en raison de la base de code, mais les erreurs suivantes étaient présentes :<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
Cela signifie que la file d’attente de réplication est bloquée et empêche l’installation de contenu modifiable supplémentaire.

Dans les logs, les erreurs `[` 1`]`  sont présents pendant la période de déploiement. Le noeud le plus probablement - `[` 2`]`  n’est pas présent sur l’éditeur et/ou le serveur d’aperçu et la réplication échoue.
...
`[` 2`]`  /content/parent_site/main_page/global/main/en_fr/page_1/page_2/page_3/page_4/page_5
