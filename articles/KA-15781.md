...
Lorsque nous exportons le rapport d’analyse descriptive, le graphique est exporté par la partie Graphique, ce qui n’est pas le cas.


## Résolution


Notre équipe d’ingénierie a accepté cette demande d’amélioration car le rapport est extrait correctement si l’option Excel est utilisée et que la section graphique est correctement exportée.
