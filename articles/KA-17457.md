...
Problèmes de performances d’AEM Sites<br>
...
4. Passez en revue les procédures de maintenance du système. Voir [article](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html)pour plus d’informations sur la maintenance d’AEM et pour vous assurer que vous effectuez une maintenance correcte sur AEM, notamment : - Nettoyage des révisions (MongoMK et base de données DocumentNodeStore uniquement) - quotidien ou plus fréquent - Compression Tar hors ligne (TarMK uniquement) - bi-hebdomadaire - Nettoyage de la mémoire d’entrepôt de données (systèmes avec FileDataStore ou S3 uniquement) - hebdomadaire - Purge de workflow - hebdomadaire - Purge de version - hebdomadaire - Purge du journal d’audit - 5. au niveau du dispatcher AEM.
6. Vérifiez la mise en cache de votre site.
...
<br> Problèmes de performances d’AEM Assets<br> 
...
<br>AEM des problèmes d’indexation<br>
...
<br>Problèmes de réplication<br>
...
<br>Problèmes de corruption TarMK<br>
