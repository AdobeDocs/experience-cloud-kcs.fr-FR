---
title: "Comprendre la mise en cache | AEM"
description: "Découvrez comment la mise en cache du Dispatcher se produit et comment elle peut être configurée dans Adobe Experience Manager."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: "KCS, mise en cache, mise en cache de Dispatcher, AEM, Experience Manager"
...
# Compréhension de la mise en cache | AEM


Dans cet article, vous découvrirez comment la mise en cache du Dispatcher se produit et comment la configurer à l’aide des répertoires de cache par défaut suivants dans vos installations de base :
...
Ce qu&#39;il faut noter ici est que la variable <b>/docroot</b> est défini sur le répertoire du cache de l’auteur.
...
Dans un scénario de création, le contenu change en permanence et volontairement. Vous souhaitez uniquement mettre en cache les éléments qui ne changeront pas fréquemment.
...
Ce paramètre peut être défini sur n’importe quelle ferme, mais son application aux fichiers de fermes publiés n’a de sens que. Voici un exemple de syntaxe de la fonctionnalité activée dans un fichier de batterie :
...
Dans l’exemple, ils ont configuré AEM pour diffuser des en-têtes que le réseau de diffusion de contenu recherche pour savoir quand invalider son cache. En d’autres termes, AEM peut désormais indiquer correctement les fichiers qui sont invalidés en fonction des en-têtes.
