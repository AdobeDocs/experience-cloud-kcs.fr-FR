...
description: "Découvrez le problème Adobe Experience Manager où le message n’est pas internationalisé."
...
Le problème est un message qui n’est pas internationalisé. Le message d’erreur &quot;Invalid date - The value must be of date datatype&quot; (Date incorrecte - La valeur doit être de date datatype) est en anglais même s’il doit être en allemand, la langue du navigateur du client.
