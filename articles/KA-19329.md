...
Le client signale un message non internationalisé. Le message d’erreur &quot;Invalid date - The value must be of date datatype&quot; (Date non valide - La valeur doit être du type de données date) est en anglais, même s’il doit être en allemand, qui est la langue du navigateur du client.
