...
Media Analytics nécessite une instance de [!UICONTROL Service d’identification des visiteurs]. Vous devez télécharger [!UICONTROL Service d’identification des visiteurs] code de [!UICONTROL Gestionnaire de code] dans l’interface utilisateur d’Adobe Analytics.

Une fois que vous avez téléchargé [!UICONTROL Service d’identification des visiteurs] code, cliquez sur le bouton + sous [!UICONTROL Actions] pour créer un élément d’action, puis
...
Media Analytics nécessite une instance de `Appmeasurement`. Vous devez le télécharger à partir de [!UICONTROL Gestionnaire de code] dans l’interface utilisateur d’Adobe Analytics.

Une fois que vous avez téléchargé le `Appmeasurement` code, cliquez sur le bouton + sous [!UICONTROL Actions] pour créer un élément d’action, puis
...
Télécharger [!UICONTROL Heartbeat] SDK à partir de [https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/sdks/js/libs](https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/sdks/js/libs).

Une fois que vous avez téléchargé le [!UICONTROL Heartbeat] code, cliquez sur le bouton + sous [!UICONTROL Actions] pour créer un élément d’action, puis
