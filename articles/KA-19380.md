...
Les opérateurs doivent avoir accès au [!UICONTROL Workflows des opérations] Dossier sous [!UICONTROL Administration] - [!UICONTROL Production] - [!UICONTROL Objets créés automatiquement] chemin d’accès.
