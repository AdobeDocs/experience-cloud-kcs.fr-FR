---
title: "Les certificats SSL sont rétablis après la permutation manuelle sur l’auteur"
...
# Les certificats SSL sont restaurés après le passage manuellement sur l’auteur
...
Le client dispose de l’environnement AEM configuré avec les 2 auteurs, éditeurs et Dispatchers. Il y a un auteur actif et un auteur de secours, les éditeurs et les dispatchers sont en haute disponibilité.
...
Après cette opération, le client a pu accéder au second. Quand tout allait bien, les auteurs étaient retournés comme avant.

La même procédure a été tentée une fois de plus, le lendemain, l’auteur secondaire a été activé, mais elle n’a pas été accessible en raison du manque de disponibilité des certificats importés précédemment.
...
Cette erreur s’affiche généralement lorsque la fonction de cryptage est rompue sur l’instance et, dans ce cas, la clé HMAC doit être synchronisée à partir de l’instance à partir de laquelle les certificats ont été importés.
